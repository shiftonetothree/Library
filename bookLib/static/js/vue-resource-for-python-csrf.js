...
/**
 * 	为了匹配django的csrf机制，此文件经过James的定制
 *	请求头都带有
...
function in_trim(str){ //删除左右两端的空格
...
var csrftoken = in_getCookie('csrftoken');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (Vue) {
	    ...
	    Http.headers = {
	        ...
	        custom: {'X-Requested-With': 'XMLHttpRequest','X-CSRFToken':csrftoken}
	    };
